...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_CGAMENOTIFICATIONS_CREATESESSION_REQUEST'].fields_by_name['steamid']._serialized_options = b'\202\265\030\254\001(Optional) steamid to make the request on behalf of -- if specified, the user must be in the session and all users being added to the session must be friends with the user.'
  ...
  _globals['_CGAMENOTIFICATIONS_DELETESESSION_REQUEST'].fields_by_name['steamid']._serialized_options = b'\202\265\030e(Optional) steamid to make the request on behalf of -- if specified, the user must be in the session.'
  ...
  _globals['_CGAMENOTIFICATIONS_UPDATESESSION_REQUEST'].fields_by_name['steamid']._serialized_options = b'\202\265\030\254\001(Optional) steamid to make the request on behalf of -- if specified, the user must be in the session and all users being added to the session must be friends with the user.'
  _globals['_CGAMENOTIFICATIONS_ENUMERATESESSIONS_REQUEST'].fields_by_name['appid']._loaded_options = None
  _globals['_CGAMENOTIFICATIONS_ENUMERATESESSIONS_REQUEST'].fields_by_name['appid']._serialized_options = b'\202\265\030kThe sessionid to request details for. Optional. If not specified, all the user\'s sessions will be returned.'
  ...
  _globals['_CGAMENOTIFICATIONS_CREATESESSION_REQUEST']._serialized_end=2044
  _globals['_CGAMENOTIFICATIONS_CREATESESSION_RESPONSE']._serialized_start=2046
  _globals['_CGAMENOTIFICATIONS_CREATESESSION_RESPONSE']._serialized_end=2151
  _globals['_CGAMENOTIFICATIONS_DELETESESSION_REQUEST']._serialized_start=2154
  _globals['_CGAMENOTIFICATIONS_DELETESESSION_REQUEST']._serialized_end=2425
  _globals['_CGAMENOTIFICATIONS_DELETESESSION_RESPONSE']._serialized_start=2427
  _globals['_CGAMENOTIFICATIONS_DELETESESSION_RESPONSE']._serialized_end=2470
  _globals['_CGAMENOTIFICATIONS_UPDATESESSION_REQUEST']._serialized_start=2473
  _globals['_CGAMENOTIFICATIONS_UPDATESESSION_REQUEST']._serialized_end=3174
  _globals['_CGAMENOTIFICATIONS_UPDATESESSION_RESPONSE']._serialized_start=3176
  _globals['_CGAMENOTIFICATIONS_UPDATESESSION_RESPONSE']._serialized_end=3219
  _globals['_CGAMENOTIFICATIONS_ENUMERATESESSIONS_REQUEST']._serialized_start=3222
  _globals['_CGAMENOTIFICATIONS_ENUMERATESESSIONS_REQUEST']._serialized_end=3767
  _globals['_CGAMENOTIFICATIONS_SESSION']._serialized_start=3770
  _globals['_CGAMENOTIFICATIONS_SESSION']._serialized_end=4349
  _globals['_CGAMENOTIFICATIONS_ENUMERATESESSIONS_RESPONSE']._serialized_start=4352
  _globals['_CGAMENOTIFICATIONS_ENUMERATESESSIONS_RESPONSE']._serialized_end=4482
  _globals['_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST']._serialized_start=4485
  _globals['_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST']._serialized_end=4955
  _globals['_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST_REQUESTEDSESSION']._serialized_start=4721
  _globals['_CGAMENOTIFICATIONS_GETSESSIONDETAILS_REQUEST_REQUESTEDSESSION']._serialized_end=4955
  _globals['_CGAMENOTIFICATIONS_GETSESSIONDETAILS_RESPONSE']._serialized_start=4957
  _globals['_CGAMENOTIFICATIONS_GETSESSIONDETAILS_RESPONSE']._serialized_end=5084
  _globals['_GAMENOTIFICATIONSETTINGS']._serialized_start=5087
  _globals['_GAMENOTIFICATIONSETTINGS']._serialized_end=5255
  _globals['_CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_REQUEST']._serialized_start=5257
  _globals['_CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_REQUEST']._serialized_end=5375
  _globals['_CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_RESPONSE']._serialized_start=5377
  _globals['_CGAMENOTIFICATIONS_UPDATENOTIFICATIONSETTINGS_RESPONSE']._serialized_end=5433
  _globals['_CGAMENOTIFICATIONS_ONNOTIFICATIONSREQUESTED_NOTIFICATION']._serialized_start=5436
  _globals['_CGAMENOTIFICATIONS_ONNOTIFICATIONSREQUESTED_NOTIFICATION']._serialized_end=5634
  _globals['_CGAMENOTIFICATIONS_ONUSERSTATUSCHANGED_NOTIFICATION']._serialized_start=5637
  _globals['_CGAMENOTIFICATIONS_ONUSERSTATUSCHANGED_NOTIFICATION']._serialized_end=6083
  _globals['_GAMENOTIFICATIONS']._serialized_start=6086
  _globals['_GAMENOTIFICATIONS']._serialized_end=7148
  _globals['_GAMENOTIFICATIONSCLIENT']._serialized_start=7151
  _globals['_GAMENOTIFICATIONSCLIENT']._serialized_end=7502
